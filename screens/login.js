...
export default function Login(props) {
  ...
  return (
    <View style={[tw`flex-1 justify-center items-center`, { backgroundColor: "rgb(35, 43, 56)" }]}>
      <View
        style={{
          backgroundColor: "#fff",
          width: "80%",
      ...
      >
        ...
        <Button
          mode="contained"
          style={[tw`w-[100%] self-center mt-4 rounded-md mt-8 text-[#fff]`, { zIndex: 0, backgroundColor: "rgb(51, 102, 255)" }]}
